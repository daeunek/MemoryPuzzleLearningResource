...
class EvenNums(Puzzle):
    def __init__(self, notebook):
        ...
        self.img1_path = 'MemoryPuzzleLearningResource/img1.png'
        self.img1 = PhotoImage(file = self.img1_path)

        self.img2_path = 'MemoryPuzzleLearningResource/evenimg2.png'
    ...
    def set_up(self, event):
        ...
        try:
            ...
            messagebox.showwarning('Index Error',"Click only on the grid")
...
class OddNums(Puzzle):
    def __init__(self, notebook):
        ...
        self.img1_p = "MemoryPuzzleLearningResource/odd1.png"
        self.img1 = PhotoImage(file = self.img1_p)

        self.img2_path = 'MemoryPuzzleLearningResource/odd2.png'
        self.img2 = PhotoImage(file = self.img2_path)
...
class PrimeNums(Puzzle):
    def __init__(self, notebook):
        ...
        self.img1_path = 'MemoryPuzzleLearningResource/prime1.png'
        self.img1 = PhotoImage(file = self.img1_path)

        self.img2_path = 'MemoryPuzzleLearningResource/prime2.png'
        self.img2 = PhotoImage(file = self.img2_path)        
...
class HomePage(object):
    def __init__(self, instance):
        ...
        img_path = "MemoryPuzzleLearningResource/final1.png"
